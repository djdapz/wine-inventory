...
describe('Wine List', () => {
  beforeEach(() => {
    ...
    window.localStorage.setItem('userName', 'Joe')
    window.localStorage.setItem('userId', '445566')
  ...
  it('should request a list of wine', function () {
    cy.wait('@getWines').should(xhr => {
      expect(xhr.request.headers['userId']).to.eq('445566')
    })
  })
