...
export class WineForm extends React.Component<WineFormProps, { request: WineRequest }> {
    ...
    updateYear = (year: number | undefined) => this.setState({request: {...this.state.request, year}})
    updateQuantity = (quantity: number | undefined) => this.setState({request: {...this.state.request, quantity}})
